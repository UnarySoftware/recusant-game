...
namespace recusant
{
    ...
    // TODO Revamp this God's forgotten class later, or replace with a thirdparty solution

    class SteamMultiplayerPeer : public godot::MultiplayerPeerExtension
    {
        GD_CLASS(SteamMultiplayerPeer, MultiplayerPeerExtension);
    ...
    private:
        ...
        godot::HashMap<int64_t, uint32_t> id_to_connections;
        godot::HashMap<uint32_t, int64_t> connections_to_id;
    ...
    public:
        ...
        godot::StringName peer_connected;
        godot::StringName peer_disconnected;
