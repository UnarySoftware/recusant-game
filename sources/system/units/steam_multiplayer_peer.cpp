...
namespace recusant
{
    ...
    {
        steam = p_steam;
        steam->connect(steam->SteamNetConnectionStatusChangedSignal, Callable(this, "steam_net_connection_status_changed"));
    }

    void SteamMultiplayerPeer::_bind_methods()
    {
        BIND_METHOD(steam_net_connection_status_changed);
    }
